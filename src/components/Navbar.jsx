...
function Navbar() {
  ...
  return (
    <div className="absolute w-full flex justify-between p-4 items-center">
      ...
      <HiMenuAlt3 onClick={toggle} className="z-20 text-white cursor-pointer" size={35} />
      <div
        className={
          isOpen
            ? "ease-in duration-300 fixed text-gray-300 left-0 top-0 w-full h-screen bg-black/80 px-4 py-8 flex-col z-10"
